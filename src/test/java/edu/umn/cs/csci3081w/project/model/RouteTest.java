...
public class RouteTest {
  ...
  private Route emptyTestRouteIn;
  ...
  public void setUp() {
    ...
    List<Stop> emptyStopsIn = new ArrayList<Stop>();
    List<Double> emptyDistancesIn = new ArrayList<>();
    List<Double> emptyProbabilitiesIn = new ArrayList<Double>();
    PassengerGenerator emptyGeneratorIn = new RandomPassengerGenerator(emptyStopsIn,
        emptyProbabilitiesIn);
