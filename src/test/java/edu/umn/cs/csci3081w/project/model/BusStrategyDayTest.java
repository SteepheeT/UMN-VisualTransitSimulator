...
public class BusStrategyDayTest {
  ...
  /**
   * Testing to get correct vehicle according to the strategy with large bus number equal with 0.
   */
  @Test
  public void testGetTypeOfVehicleWithLargeBusNumberIsZero() {
  ...
  /**
   * Testing to get correct vehicle according to the strategy with small bus number equal with 0.
   */
  @Test
  public void testGetTypeOfVehicleWithSmallBusNumberIsZero() {
