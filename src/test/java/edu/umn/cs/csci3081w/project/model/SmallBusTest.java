...
public class SmallBusTest {
  ...
  public void testReport() {
    ...
    try {
      ...
      Passenger passenger = new Passenger(5, "testPassenger");
  ...
  /**
   * Tests if updateDistance function works properly when have passenger.
   */
  @Test
    ...
    try {
      ...
      String strToCompare =
          "####Small Bus Info Start####" + System.lineSeparator()
              ...
              + "Num of passengers: 1" + System.lineSeparator()
              + "####Passenger Info Start####" + System.lineSeparator()
              + "Name: test passenger" + System.lineSeparator()
